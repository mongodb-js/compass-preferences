...
describe('Preferences [Component]', () => {
  describe('#render', () => {
    context('when the product is compass', () => {
      let component;
      const prefs = {};
    ...
    context('when the product is compass community', () => {
      let component;
      const prefs = {};

      beforeEach(() => {
        component = mount(
          <Preferences preferences={prefs} productName="mongodb-compass-community" isVisible />
        );
      });
      ...
      it('does not render the feeback checkbox', () => {
        expect(component.find('[data-test-id="product-feedback-checkbox"]')).to.not.be.present();
      });

      it('does not render the geo checkbox', () => {
        expect(component.find('[data-test-id="enable-maps-checkbox"]')).to.not.be.present();
      });
